...
public class NotificationBackgroundService(NotificationQueue queue, IServiceProvider serviceProvider, ILogger<NotificationBackgroundService> logger) : BackgroundService
{
