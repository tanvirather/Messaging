...
{
    private readonly WelcomeRepository _repository;
    ...
    public WelcomeRepositoryTest()
    {
        ...
        _repository = new WelcomeRepository(dataLoader.Context);
    }
    ...
    public async Task Get_WhenUserExists_ShouldReturnWelcomeModel()
    {
        // Arrange
        // Act
        var result = await _repository.Get(new Guid("3a4b5c6d-7e8f-9a0b-1c2d-3e4f5a6b7c8d"));
        // Assert
