...
namespace Zuhid.Notification.Tests.NewFeature
{
    ...
    {
        private readonly NewFeatureRepository repository;
        ...
        public NewFeatureRepositoryTest()
        {
            ...
            repository = new NewFeatureRepository(dataLoader.Context);
        }
...
Verify that the mapper correctly replaces placeholders in the HTML template and returns the expected subject.
...
namespace Zuhid.Notification.Tests.NewFeature
{
    public class NewFeatureMapperTest
    {
        ...
        public async Task Map_ShouldReturnExpectedSubjectAndBody()
        {
            ...
            // Act
            var (subject, body) = await mapper.Map(model);
